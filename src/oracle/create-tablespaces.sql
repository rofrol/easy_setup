...
BEGIN
     EXECUTE IMMEDIATE 'CREATE TABLESPACE BAP_DATA DATAFILE ''BAP_DATA.dbf'' SIZE 40M ONLINE';
     EXECUTE IMMEDIATE 'CREATE TABLESPACE BAP_INDX DATAFILE ''BAP_INDX.dbf'' SIZE 40M ONLINE';
EXCEPTION
